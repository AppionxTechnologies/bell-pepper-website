    ...
    <>
      ...
      <div className="catering-container">
        <div className="p-2">
          ...
          <p className="light">
            Large version of our popular Main courses with your protein & side
            selection. Our catering tray serves 6. Great for a house or office
            party.
          </p>
          <p className="light">
            Price includes disposable plates and cutlery’s{" "}
          </p>
        </div>
