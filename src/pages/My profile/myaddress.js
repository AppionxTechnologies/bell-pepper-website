      ...
      <div className="col-lg-12">
        <div className="row mt-4">
          ...
          <div className="col-lg-9 mt-3">
            ...
            <div className="myaddress-heading"><p className="fw-bold">MY ADDRESS</p></div>
            <div className="row">
              <div className="col-lg-8 bg-white home-address">
                <div className="home-with-icon">
                  <p className="homeicon-content fw-semibold px-3">
                    <img
                      className="home-icon-myaddress"
                      src={homeicon}
                      alt=""
                    />
                    HOME
                ...
                <div className="myaddress-btn">
                  <button
                    className="myaddress-button fw-semibold mt-2"
                    type="button"
                  >
                    EDIT
                  </button>
            ...
            <div className="row">
              <div className="col-lg-12 mt-5 add-address-content text-center">
                <p
                  className="fw-semibold"
                  onClick={ShowMyaddress ? closeMyaddress : openMyaddress}
                >
                  ADD ADDRESS
                </p>
              </div>
